...
Motor Motor1(5, 3, 4, 22, 24);
Motor Motor2(6, 7, 8, 26, 28);
...
pid pid1(30.0, 3.0, 0.0);
pid pid2(30.0, 3.0, 0.0);
...
void loop() {
    ...
    if (dt >= 50) {
      ...
      dl2 =  3.14 * 0.075 * (enc_value2 - enc_last_value2) / 49860.0;
      v2 = 1000 * dl2 / dt;
      ...
      v_motor1 = pid1.calculate(2.0, v1, dt);
      v_motor2 = pid2.calculate(2.0, v2, dt);
  
      Motor1.commandMotor(100);
      Motor2.commandMotor(100);
